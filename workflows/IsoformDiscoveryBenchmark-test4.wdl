...
workflow LongReadRNABenchmark {
    ...
    Array[File] gtfListReduced = [Mandalorion.MandalorionGTF, IsoQuant.isoQuantGTF, IsoQuantv2.isoQuantv2GTF, StringTie.stringTieGTF, Bambu.bambuGTF, Flair.flairGTF, Flames.flamesGFF]
    ...
    Array[String] toolNamesReduced = ["mandalorion", "isoquant", "isoquantv2", "stringtie", "bambu", "flair", "flames"]
