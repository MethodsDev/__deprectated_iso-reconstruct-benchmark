...
task MandalorionTask {
 ...
 #       samtools bam2fq ~{inputBAM} > samtools.bam2fq.fastq
        ...
        /usr/local/src/Mandalorion/minimap2/minimap2 --secondary=no -uf -ax splice:hq --cs=long --junc-bed anno.bed -t ~{numThreads} ~{referenceGenome} ~{inputBAM} > samtools.view.sam
